...
$$ \begin{rcases} I=I_o\cos^2\left(\dfrac{\Delta \Phi}{2}\right) \\ \Delta \Phi = \dfrac{2\pi}{\lambda}\Delta x \\ \Delta x = d\sin\theta \end{rcases} \Rightarrow I\left(\theta\right) = I_o\cos^2\left[\dfrac{\pi d\sin\theta}{\lambda}\right] $$
